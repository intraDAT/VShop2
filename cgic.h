...
extern cgiFormEntry* cgiFormEntryGetFirst();
extern cgiFormEntry* cgiFormEntryGetNext();
...
extern char *cgiReferer;
extern char *cgiRemoteAddr;
extern char *cgiRemoteHost;
extern char *cgiCookie;

extern char PROGRAMNAME[40];
extern char CGIBIN[150];
extern char SECURECGIBIN[150];
extern char BASEREF[150];
extern char SECUREBASEREF[200];
extern char TEMPLATEROOT[200];
extern int VSHOP_PROFILING;
extern char PROGRAMPATH[256];
extern char ENGINEPATH[256];
...
extern void InsertEntry(char* Name, char* Value);

extern char* String2HREF(char* String);

extern void GetUpload();

extern char* cgiString(char *name);
