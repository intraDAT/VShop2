...
main (int argc, char **argv)
{
  ...
  if (VsadFile (vsBuffer) != 0)
    {
      printf ("\n\n(011) FEHLER: Die Datei '/opt/vshop/vsadmin.conf' kann nicht gelesen werden.\nDas Update wurde abgebrochen !\n");
      UpExit (-1);
    }
...
*/
      ...
      if ((testPtr = getcwd (&startwd[0], 255)) != &startwd[0])
	{
      ...
      if (stat ("/opt", &fstat) != 0)
	{
	  printf ("\n\n(015) FEHLER: Das Verzeichniss '/opt' existiert nicht. Das Administrationsprogramm wurde nicht gefunden.\nDas Update wurde abgebrochen !\n");
	  UpExit (-1);
	}
	...
	{
	  printf ("\n\n(016) FEHLER: Das Verzeichniss '/opt/vshop' existiert nicht. Das Administrationsprogramm wurde nicht gefunden.\nDas Update wurde abgebrochen !\n");
	  UpExit (-1);
	}
...
\t UPDATE des Shops \"%s\"\n\n", &tableNam[0]);
  ...
  if (ShSystem (&systemStr[0]) != 0)
    {
      printf ("\n\n(048) FEHLER: Fehler beim Ausfuehren von 'cp'.\nDas Update wurde abgebrochen !\n");
      UpExit (-1);
    }
  ...
  if (ShSystem (&systemStr[0]) != 0)
    {
      printf ("\n\n(049) FEHLER: Fehler beim Ausfuehren von 'cp'.\nDas Update wurde abgebrochen !\n");
      UpExit (-1);
    }
  ...
  if (ShSystem (&systemStr[0]) != 0)
    {
      printf ("\n\n(050) FEHLER: Fehler beim Ausfuehren von 'cp'.\nDas Update wurde abgebrochen !\n");
      UpExit (-1);
    }
